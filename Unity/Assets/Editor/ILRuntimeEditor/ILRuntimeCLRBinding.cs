...
namespace ET
{
    public static class ILRuntimeCLRBinding
    {
        ...
        [MenuItem("Tools/ILRuntime/开启ILRuntime")]
        private static void OpenILRuntime()
        {
        ...
        [MenuItem("Tools/ILRuntime/关闭ILRuntime")]
        private static void DisableILRuntime()
        {
            ScriptingDefineSymbols.RemoveScriptingDefineSymbol(EnableILRuntimeScriptingDefineSymbol);
        }
        ...
        private static void GenerateCrossbindAdapter()
        {
            ...
            using (System.IO.StreamWriter sw = new System.IO.StreamWriter("Assets/Mono/ILRuntime/IBeanBaseAdapter.cs"))
            {
                sw.WriteLine(ILRuntime.Runtime.Enviorment.CrossBindingCodeGenerator.GenerateCrossBindingAdapterCode(
                    typeof (Bright.Config.BeanBase), "ET"));
            }
