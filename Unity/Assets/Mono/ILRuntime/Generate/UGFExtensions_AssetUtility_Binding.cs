...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UGFExtensions_AssetUtility_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetHotfixConfigAsset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetHotfixConfigAsset_1);
            args = new Type[]{typeof(System.String)};
        ...
        static StackObject* GetHotfixConfigAsset_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = UGFExtensions.AssetUtility.GetHotfixConfigAsset(@assetName);
