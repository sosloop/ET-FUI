...
{
    unsafe class ET_ETTask_1_TextAsset_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ETTask<UnityEngine.TextAsset>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<UnityEngine.TextAsset> instance_of_this_method = (ET.ETTask<UnityEngine.TextAsset>)typeof(ET.ETTask<UnityEngine.TextAsset>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
