...
//         }
        ...
        /// 加载资源（可等待）
        /// </summary>
        public static async ETTask<T> LoadAssetAsync<T>(this ResourceComponent resourceComponent, string assetName)
            where T : UnityEngine.Object
        {
            ...
            return await loadAssetTcs;
        }

        /// <summary>
        /// 加载多个资源（可等待）
        /// </summary>
//         public static async ETTask<T[]> LoadAssetsAsync<T>(this ResourceComponent resourceComponent,
