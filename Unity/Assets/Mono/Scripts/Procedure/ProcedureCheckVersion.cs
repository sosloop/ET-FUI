...
namespace UGFExtensions
{
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                GameEntry.BuiltinData.UpdateResourceForm.SetTip("开始准备下载更新...");
            ...
            {
                GameEntry.BuiltinData.UpdateResourceForm.SetTip("开始检验本地资源完整...");
        ...
        private void OnWebRequestSuccess(object sender, GameEventArgs e)
        {
            ...
            if (m_VersionInfo.ForceUpdateGame)
            {
                ...
                GameEntry.BuiltinData.UpdateResourceForm.SetTip("需要下载新版本！");
        ...
        private void OnWebRequestFailure(object sender, GameEventArgs e)
        {
            ...
            GameEntry.BuiltinData.UpdateResourceForm.SetTip("网络错误！");
        }
