...
namespace FUIEditor
{
    public static class FUICodeSpawner
    {
        ...
        private static void ParseAllPackages()
        {
            ...
            string fuiAssetsDir = Application.dataPath + "/../../FGUIProject/FGUIHotfixProject/assets";
        ...
        {
            Debug.Log("SpawnCodeForPanelSystem");
