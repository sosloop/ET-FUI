...
namespace UGFExtensions
{
    public class ProcedureUpdateVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntrys.Resource.UpdateVersionList(procedureOwner.GetData<VarInt32>("VersionListLength"), procedureOwner.GetData<VarInt32>("VersionListHashCode"), procedureOwner.GetData<VarInt32>("VersionListCompressedLength"), procedureOwner.GetData<VarInt32>("VersionListCompressedHashCode"), m_UpdateVersionListCallbacks);
        ...
        private void OnUpdateVersionListSuccess(string downloadPath, string downloadUri)
        {
            ...
            GameEntrys.BuiltinData.FUIBootUI.SetTip("资源版本下载成功！");
        }
        ...
        private void OnUpdateVersionListFailure(string downloadUri, string errorMessage)
        {
            ...
            GameEntrys.BuiltinData.FUIBootUI.SetTip("资源版本下载失败！");
        }
    }
}
